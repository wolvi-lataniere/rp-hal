...
//!
//! For a detailed example, see [examples/multicore-fifo-blink.rs](https://github.com/rp-rs/rp-hal/tree/main/rp2040-hal-examples/src/bin/multicore-fifo-blink.rs)
